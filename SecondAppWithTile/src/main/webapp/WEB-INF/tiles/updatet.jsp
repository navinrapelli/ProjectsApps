...
<form  id="frmupdate"  action="<%=request. getContextPath( )%>/save/${up.UID}/${page}" method="POST">
...
<script type="text/javascript"  src=<%=request. getContextPath( )%>/"validateupdate.js"></script>
